export const psychologistMessages = {
    SUCCESS: {
        ...
        FETCHED_TOP_USERS: 'Fetched top users successfully',
        FETCHED_TOP_RATED_CONSULTATIONS: 'fetched top rated consultations successfully',
        FETCHED_TOTALS: 'fetched totals successfully',
    },
    ERROR: {
