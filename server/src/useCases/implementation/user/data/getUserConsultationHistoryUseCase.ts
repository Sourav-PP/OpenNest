...
import { IGetUserConsultationHistoryRequest, IGetUserConsultationHistoryResponse } from '@/useCases/types/userTypes';
...
export class GetUserConsultationHistoryUseCase implements IGetUserConsultationHistoryUseCase {
    ...
    async execute(input: IGetUserConsultationHistoryRequest): Promise<IGetUserConsultationHistoryResponse> {
