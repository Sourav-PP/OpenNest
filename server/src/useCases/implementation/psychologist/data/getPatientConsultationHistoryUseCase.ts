...
import { IGetPatientConsultationHistoryRequest, IGetPatientConsultationHistoryResponse } from '@/useCases/types/psychologistTypes';
...
export class GetPatientConsultationHistoryUseCase implements IGetPatientConsultationHistoryUseCase {
    ...
    async execute(input: IGetPatientConsultationHistoryRequest): Promise<IGetPatientConsultationHistoryResponse> {
        ...
        const totalCount =
            await this._consultationRepo.countPatientHistory(psychologistId, patientId);
