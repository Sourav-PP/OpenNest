          ...
          <div className="order-1 lg:order-2 space-y-8">
            ...
            <div>
              ...
              <p className="text-gray-600 lg:text-lg leading-relaxed">
                Top Therapists, Counsellors, Mental Health Experts in India. See the List of Top Psychologists in India. Best{' '}
            ...
            <div>
              <h3 className="text-2xl font-semibold text-primaryText mb-4">
