...
export const walletApi = {
  ...
  createTransaction: async (walletId: string, data: { amount: number; type: 'credit' | 'debit' }) =>
    server.post<IWalletTransaction, typeof data>(`/wallet/${walletId}/transactions`, data),
