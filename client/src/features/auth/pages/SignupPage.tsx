...
export default function SignupPage() {
  return (
    <div className="relative flex items-center justify-center min-h-screen px-4 sm:px-6 bg-auth bg-cover bg-center py-8 sm:py-12 overflow-auto">
      ...
      <div className="relative z-10 bg-white p-10 rounded-[40px] shadow-2xl w-full max-w-sm mx-auto sm:w-96 text-gray-500 text-sm">
        <h2 className="text-3xl font-bold text-[#3EB1EB] text-center">Create Account</h2>
