...
const BellButton = () => {
  ...
  return (
    <div className="relative">
      <button
        onClick={toggleModal}
        className="w-[35px] h-[35px] sm:w-[40px] sm:h-[40px] flex items-center justify-center bg-[#dbdbdb] rounded-full cursor-pointer shadow-md border-none hover:bg-[#cccccc] active:scale-90 transition-all duration-300 group relative"
      >
