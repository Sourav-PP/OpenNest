    ...
    <section className="w-full py-12 sm:py-16 bg-white">
      <div className="container mx-autpx-7 px-6 sm:px-24 lg:px-36 flex flex-col sm:flex-row items-center justify-between">
        ...
        <div className="w-full sm:w-1/2 mb-8 sm:mb-0 text-left">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-primaryText mb-6 sm:mb-4 text-center sm:text-left leading-7 sm:leading-none">
            Best Online Counselling and Therapy Consultation
          </h2>
          <p className="text-sm text-center sm:text-left sm:text-base md:text-lg text-gray-500 leading-snug sm:leading-relaxed">
