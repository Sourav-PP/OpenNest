    ...
    <section className="relative w-full h-[60vh] sm:h-auto">
      ...
      <div className="absolute inset-0 flex items-center justify-center sm:justify-start text-center sm:text-start px-7 sm:px-36 pt-36 sm:pt-24 bg-black/40 sm:bg-black/10">
        <div className="max-w-full sm:max-w-xl">
          ...
          <p className="text-sm sm:text-lg mt-4 text-white sm:text-gray-800 mb-2 sm:mb-5 drop-shadow-md sm:drop-shadow-none">
          ...
          <div className="group text-center sm:text-start">
            <button
              ...
              className="btn-primary px-6 py-2 shadow-xl border-2 border-[#535eff] sm:border-none sm:shadow-none sm:px-auto sm:py-auto text-white bg-[#3EB1EB] sm:bg-inherit hover:bg-[#2A9CDB] sm:hover:bg-inherit transition-colors duration-200 group-hover:animate-glow-ring"
