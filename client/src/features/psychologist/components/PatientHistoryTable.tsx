...
const PatientHistoryTable = () => {
  ...
  const columns = [
    ...
    { header: 'Time', render: (c: IPatientConsultationHistoryDto) => formatTimeRange(c.startDateTime, c.endDateTime).toLocaleString() },
  ...
  return (
    <div className="px-4 sm:px-6 lg:px-8 py-8">
      ...
      <ReusableTable
        data={consultations}
        columns={columns}
        emptyMessage="No past consultations found."
      />
